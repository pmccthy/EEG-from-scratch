...
-
TODO: encapsulate inside class which takes params and can write to
       arbitrary location (file, queue etc.). Could have real-time sig proc
       e.g. FFT, averaging, etc. in future
 """
import serial
import time
import csv
